        ...
        <div className={sectionstyles.center} id={"contact"}>
            <Container>
                ...
                <p>If you have any questions about me or my projects feel free to contact me. You can also check out
                    my <a href={"Resume_Charteros.pdf"} target={"_blank"} rel="noreferrer"><b>Resume</b></a> to find about more about me. I am open to conversations and eager to talk about
                    new opportunities. </p>
