        ...
        <div id="portfolio" className={styles.center}>
            <Container>
                    ...
                    <Row css={css`align-items: center; justify-content: center`}>
                        ...
                        <Col sm={12} md={6} lg={4}>
                            <Card to={"http://www.pyxida.aueb.gr/index.php?op=view_object&object_id=8109"}>
                                ...
                                <Card.Body>A novel approach to improve the global model convergence
                                    speed as well as to create personalized local models for each device in Federated Learning</Card.Body>
                                <Card.Credentials>
                                    <Card.Block>Python</Card.Block>
                                </Card.Credentials>
                            </Card>
                        ...
                        <Col sm={12} md={6} lg={4}>
                            <Card to={"https://play.google.com/store/apps/details?id=lefteris.harteros.gr.koksotiriou&hl=el&gl=US"}>
                        ...
                        <Col sm={12} md={6} lg={4}>
                            <Card to={"https://lethrodou.gr"}>
                                ...
                                <Card.Body>A web app for food orders, haircut reservations and booking system for Rhodes Greek Army Officers Club</Card.Body>
                                <Card.Credentials>
                        ...
                        <Col sm={12} md={6} lg={4}>
                            <Card to={"https://github.com/harteros/matrix-factorization-recommendation-system"}>
                                ...
                                <Card.Body>A recommendation system using matrix factorization algorithm with client application</Card.Body>
                                <Card.Credentials>
                                    <Card.Block>Java</Card.Block>
                                </Card.Credentials>
                            </Card>
